...
public class AllSafetyModeActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    private void showDialogForPermission(String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AllSafetyModeActivity.this);
        builder.setTitle("알림");
